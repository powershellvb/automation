...
cls
$FileName = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Test_output.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Test.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Test_output.htm"
