...
cls
$FileName = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Dev_output.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Dev.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Dev_output.htm"
