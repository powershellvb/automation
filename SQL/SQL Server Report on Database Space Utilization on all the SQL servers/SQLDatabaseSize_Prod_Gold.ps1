...
cls
$FileName = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Gold_output.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Prod_Gold.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Gold_output.htm"
