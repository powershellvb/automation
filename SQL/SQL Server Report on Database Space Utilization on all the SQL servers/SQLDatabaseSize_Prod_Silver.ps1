...
cls
$FileName = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Silver_output.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Prod_Silver.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Silver_output.htm"
