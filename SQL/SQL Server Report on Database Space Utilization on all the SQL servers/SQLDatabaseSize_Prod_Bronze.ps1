...
cls
$FileName = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Bronze_output.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Prod_Bronze.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\SQLDatabaseSize_Prod_Bronze_output.htm"
