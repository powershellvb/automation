...
cls
$ServerList = Get-Content "D:\Automation\DatabaseSizeAutomation\Prod.txt"
$OutputFile = "D:\Automation\DatabaseSizeAutomation\ServerLastRebootedProd.htm"
...
$HTML = '<style type="text/css">
  ...
  <TR> <td colspan=4 align=center align=center width:100px >Prod-Servers Last rebooted time for the  SQL Server  hosted in  SHC More than 100 Days   $currdate  
