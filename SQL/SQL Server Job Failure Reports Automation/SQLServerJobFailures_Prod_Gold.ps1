...
$FileName = "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Gold.htm"
if (Test-Path $FileName) {
  Remove-Item $FileName
}

$sqlservers = Get-Content "D:\Automation\JobFailures\Prod_Gold.txt"
$OutputFile = "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Gold.htm"
...
$HTML += "<HTML><BODY><Table border=1 cellpadding=0 cellspacing=0 width=100% id=Header> 
 ...
 <TR bgColor='#EFECF9'><TD colspan=5 align=center height=25 color:#F9F8FC><B>SQL Server Job Failures With in Last 24 hours Reports Prod Gold Servers : $date <B> </TD></TR>"
 $HTML += "
                                <TR>
...
send-mailmessage -from "DL-HCL-SQL@stanfordhealthcare.org" -to "DL-HCL-SQL@stanfordhealthcare.org" -subject "SQL Server Job Failures With in Last 24 hours Report - Prod servers  " -body "SQLServer Job Failures with in  Last 24 hours Report - Prod servers " -Attachments "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Silver.htm",  "D:\Automation\JobFailures\SQLServerJobFailureProd_Bronze.htm", "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Gold.htm" -smtpServer smtp.stanfordmed.org
#send-mailmessage -from "DL-HCL-SQL@stanfordhealthcare.org" -to "DL-HCL-SQL@stanfordhealthcare.org" -subject "SQL Server Job Failures With in Last 24 hours Report - Prod servers  " -body "SQLServer Job Failures with in  Last 24 hours Report - Prod servers " -Attachments "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Silver.htm",  "D:\Automation\JobFailures\SQLServerJobFailureProd_Bronze.htm", "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Gold.htm" -smtpServer smtp.stanfordmed.org