$FileName = "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Silver.htm"
...
# First lets create a text file, where we will later save the freedisk space info 
 $sqlservers = Get-Content "D:\Automation\JobFailures\Prod_Silver.txt"
$OutputFile = "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Silver.htm" 
...
$HTML += "<HTML><BODY><Table border=1 cellpadding=0 cellspacing=0 width=100% id=Header> 
 ...
 <TR bgColor='#EFECF9'><TD colspan=5 align=center height=25 color:#F9F8FC><B>SQL Server Job Failures With in Last 24 hours Reports Prod Silver Servers : $date <B> </TD></TR>"
 $HTML += "
                                <TR>
...
send-mailmessage -from "NMoorthy@stanfordhealthcare.org" -to "NMoorthy@stanfordhealthcare.org" -subject "SQL Server Job Failures With in Last 24 hours Report - Prod_Gold Servers" -body "SQLServer JOb Failure with in  Last 24 hours Report - Prod_Gold Servers" -Attachments "D:\Automation\JobFailures\SQLServerJobFailure_Prod_Silver.htm" -smtpServer smtp.stanfordmed.org