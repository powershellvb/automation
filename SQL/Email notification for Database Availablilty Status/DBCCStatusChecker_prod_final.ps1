cls
$ServerList = Get-Content "D:\Automation\DatabaseStatusCheckerReport\Prod.txt"
$OutputFile = "D:\Automation\DatabaseStatusCheckerReport\ProdDBAvailabilty_Report.htm"
$currdate = (Get-Date).ToString('yyyy/MM/dd')
  ...
  <TR> <td colspan=3 align=center align=center width:100px >Prod-Servers Database Availabilty Report   $currdate  
...
$HTML += "<TR>
                                                                                <TD> "+ $instance + "</TD>
                                                                                <TD> "+ $row[0] + "</TD>
                                                                                <TD bgcolor='#FF0000' align=center width=100px> "+ $row[1] + "</TD>
...
$messageSubject = "Prod-Servers Database Status Report $date"
